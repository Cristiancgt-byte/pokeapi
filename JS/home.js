function generarLista(arraypokemones) {
    ...
    for (let i = 0; i < arraypokemones.length; i++) {
        ...
        <div class="c-lista-pokemon poke-${id}" onclick="Detalle('${id}')">
            <p>#${id}</p>
            <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png" width="auto" height="100" loading="lazy" alt="${arraypokemones[i].name}">
